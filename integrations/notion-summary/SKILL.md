...
- **자동 분할**: Notion 블록 제한(100개) 초과 시 자동 분할, 각 페이지에 시리즈 네비게이션 추가
...
### 페이지 분할 시 시리즈 네비게이션 (자동)

문서가 커서 Notion 블록 제한(100개)을 초과하면 자동으로 여러 페이지로 분할됩니다.
이때 각 페이지 하단에 **시리즈 네비게이션**이 자동으로 추가됩니다:

```
---
📚 시리즈: 2025-01-30-report-대규모문서 (2/3)
...
### 예시 4: 대용량 문서 업로드 (자동 분할)

```
사용자: 전체 API 문서 노션에 올려줘

Claude: 문서를 확인합니다.

📄 .context/full-api-docs.md (15,200자)

⚠️ 대용량 문서 (Notion 블록 250개):
- 3개 페이지로 자동 분할됩니다.
- 각 페이지에 시리즈 네비게이션이 추가됩니다.

업로드 중...
   시리즈 네비게이션 추가 중...

✅ 업로드 완료
- 제목: 2025-01-30-document-full-api-docs
- 문서 길이: 15,200자
- Notion 블록: 250개
- 분할 페이지: 3개
- 📚 시리즈 네비게이션: 각 페이지에 추가됨
- URL: https://notion.so/xxxxx
```
