...
const OUTPUT_DIR = '/Users/jiun/workspace/jiunbae.github.io/contents/posts/2025-01-04-claude-code-cloud';
const BASE_URL = 'https://claude.jiun.dev';
const LOGIN_EMAIL = 'maytryark@gmail.com';
const LOGIN_PASSWORD = 'Jiun5486@#';
